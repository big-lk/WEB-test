...
const resumeCopy = {
  ...
  zh: {
    eyebrow: '简历',
    name: '孔维鹏',
    headline: '工业设计 / HCI / 感性工学',
    summary:
      '关注人与产品、技术之间感性体验的设计研究者。目前在札幌学习工业设计，通过用户研究、感性评价、原型设计与 UI/UX 设计，把模糊的感受转化为可讨论、可验证、可用于设计判断的线索。',
    ...
    skills: ['工业设计', 'UI/UX 设计', '人机交互', 'AI 交互设计', '移动出行 HMI', 'AR 体验设计', '产品服务系统'],
    methods: ['访谈与观察', '语义差异法', '感性评价', '场景设计', '原型测试', '系统映射', 'UX 旅程图', '数据可视化'],
    focus: [
      '将情绪印象转化为可分析、可比较的设计变量。',
      '在 AI 支持的体验中保留人的主导权、透明性、信任和作者感。',
      '连接实体产品、界面层、时间、位置与日常行为。',
    ],
    labels: { role: '负责内容', methods: '方法', value: '项目价值' },
  },
}
