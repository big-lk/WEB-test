...
const copy = {
  ...
  zh: {
    back: '返回作品列表',
    eyebrow: 'AR 旅行摄影 · 研究进行中',
    title: 'FrameTrace',
    subtitle: '把照片参考变成空间引导',
    summary: '探索如何帮助旅行者找到过去的摄影机位、对齐构图，并在真实地点重新进入公共或私人的照片记忆。',
    role: '独立完成概念研究、空间 UX、AR 交互与 Quest 3 原型 · 2025–2026',
    nav: [['概念', '#concept'], ['调查', '#research'], ['下一步方向', '#direction'], ['原型', '#prototype']],
    conceptKicker: '机会点',
    conceptTitle: '收藏一张好照片，并不等于能在现场重新拍出来。',
    conceptCopy: '用户能看到成片，却不知道摄影者准确站在哪里、朝向哪里、用了什么焦距和构图。FrameTrace 探索能否把这些信息保存成 Photo Trace，在原地点重新调用。',
    insight: '把二维照片参考，转化成真实空间中可以行动的引导。',
    journey: [['寻找', '只查看附近少量摄影痕迹。'], ['到达', '用简单的方向和距离走到原机位。'], ['复现', '停止后对齐历史构图，完成新的拍摄。']],
    researchKicker: '概念印象调查',
    researchTitle: '调查给出的提示，以及它还不能证明的事情',
    ...
    directionKicker: '下一步设计方向',
    directionTitle: '下一版计划调整什么',
    directions: [['一个主要任务', '把公共机位复现整理为寻找、行走、对齐、拍摄的一条主线。'], ['一个情感支线', '把私人旧照回访与公共痕迹分开，保留为个人记忆体验。'], ['行走时减少信息', '移动时只显示方向和距离，停止后再加载构图。'], ['增加用户控制', '解释推荐原因；新痕迹默认私密；分享必须主动选择。']],
    directionNote: '这些是调查结果提出的下一步设计假设，目前还没有在新版原型中完成实现和验证。',
    experienceKicker: '下一版拟验证流程',
    experienceTitle: '发现痕迹，到达机位，重新完成构图',
