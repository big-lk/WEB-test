...
const copy: Record<Language, CaseCopy> = {
  zh: {
    ...
    uiKicker: '界面设计',
    uiTitle: '降低开始、记录与回看的成本',
    uiCopy: '界面没有追求复杂仪表盘，而是用少量高识别元素组织任务：感觉卡片负责开始，珊瑚红主按钮负责行动，时间轴负责展示积累。',
    uiPoints: [
      {
        ...
        alt: '好久没吃小程序首页真实界面',
        attraction: '为什么这样做：先问感觉，再给候选，让首页更接近自我判断，而不是另一个外卖列表。',
      },
      {
      ...
      },
      {
        ...
        alt: '好久没吃小程序回忆页真实界面',
        attraction: '为什么这样做：积累被看见以后，下一次记录就不再像从零开始。',
      },
    ],
    ...
    resultKicker: '当前结果',
    resultTitle: '从概念板推进到可运行的微信小程序 MVP',
    resultCopy: '当前版本已经覆盖首次理解、记录、查找回忆到再次品尝的主要流程，并把隐私控制放在核心流程内，而不是作为上线后的补充。',
    result: [['核心流程', '首次教程、首页、记录、回忆、再会、详情、个人偏好与隐私说明。'], ['私人数据', '个人记录与偏好相互隔离，照片、地点和文字默认不公开，并支持删除与导出。'], ['提示理由', '依据时间距离、喜欢程度、感觉与情境排序，同时向用户说明为什么此刻出现。']],
    nextTitle: '接下来要看什么',
